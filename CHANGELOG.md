...
* Fixes:
  ...
  * Fix for defence not applied during combat checks as setback dice
	defence mods to distinguish between melee and ranged ([#1985](https://github.com/StarWarsFoundryVTT/StarWarsFFG/issues/1985))
